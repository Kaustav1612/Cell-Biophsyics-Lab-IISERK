function [cluster_centers,cluster_assignments,features,final_object_positions] = cluster_object_space(roi,type,filtered_img_norm,params)
        ...
        epsilon = params.epsilon; % Convergence Checker Parameter for shifting of the cluster center until it reaches the attraction basin
        learning_parameter = params.learning_parameter; % Rate of Learning
        merge_distance = params.merge_distance; %Thresholding using the density map
        
        [final_object_positions] = shift(features,epsilon,params.bandwidth,learning_parameter,type,Intensity_map,filtered_img_norm);
