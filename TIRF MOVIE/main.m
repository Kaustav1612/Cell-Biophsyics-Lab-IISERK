...
olddir=cd('J:\Jibitesh\TIRF\10723\Control\Exported\Control_005\set');
directory = "J:\Jibitesh\TIRF\10723\Control\Exported\Control_005\";
...
redrawing = true;
while redrawing
  imshow(image_stack (:,:,1),[0 600]);  % Display the black and white image
...
alpha = 0.8;                  % Position vs. features weight
...
min_merged_length = 50;     % Minimum length after merging to keep
