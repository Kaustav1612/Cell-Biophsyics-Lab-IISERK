...
%%
num_channels = 2;
channel_1_dir='F:\Uday_data\24_02_24(Jas_live_img1)\200nm_jaxpa\Cell 5\TNFR1_1';
channel_2_dir= 'F:\Uday_data\24_02_24(Jas_live_img1)\200nm_jaxpa\Cell 5\Actin_1';
directory = 'I:\mobility_analysis\Jas_live_img_1\200nM\05';
...
figure;
imshowpair(detected_movie_channel_1(:,:,1), detected_movie_channel_2(:,:,1));
hold on;
...
save(results_file_name, 'kymograph_stitched_intensity', 'kymograph_stitched', 'total_lifetime_normalized','TAMSD','MSD','D','slope_vector','new_stats','trajectories');
cd(olddir);
